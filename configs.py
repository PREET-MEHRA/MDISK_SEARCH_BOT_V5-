...
class Config(object):
    ...
    API_HASH = os.getenv("API_HASH", "3f02c2df6069de8c1a2abf623da0a4b8")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5959827404:AAE9mnqwU4SOl3dixiwnrF0fzGauFzPia_8")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "mdiskcynitebot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "1BVtsOLcBuzjM_k10ZVwrggb1EwcJ6QTanGuCRCSqQF_EH_j1jHfMwh09VJ68A2v0WXCmXzj-o-vewnY62mbTJw6BxiVJm_fMwZzQvwypFa0lm-f3rDox1zjWJEQK25to5jmDwjs6InZg9QjHs2dIXY_8A1XSJWJGOKSJayHPnAfcg2t5NfpQUkeppTntc7uhebWoUq1MlNPTq6W3lxWxD-Mm4WY7C5b5LEBspj1k2UD2fcyFzLCD0l4Wn8mU5jPZ3SPHc89EGVs3XBOxHu-nbl0jtH68F-C8itDvB0-rSJvCyHpyEnckwXv_zeIQR5I8vYoxCpGXXLYvWMkorLFJa9_JlEOaLio=")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001646902389")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "MDISK_MOVIES_VILLA_BOT")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5182744288"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "ROYAL_PREET_MEHRA")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "Mdsik_backup_villa")
...
Jᴜsᴛ Tʏᴘᴇ ᴀ Mᴏᴠɪᴇ Nᴀᴍᴇ 🎬**""" ) 
    START_PHOTO = os.getenv("START_PHOTO", "https://te.legra.ph/file/bf8004f6c042b104fe447.jpg")
    HOME_TEXT = os.getenv("HOME_TEXT", """ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕

ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ʏᴏᴜʀ ʟɪɴᴋꜱ.

ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001853338270")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Preet:deep@cluster0.k92mpcj.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001606525079"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "Mdisk_update_villa")
    FORCE_SUB = os.getenv("FORCE_SUB", "true")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    MDISK_API = os.getenv("MDISK_API", "lPfZFwpjYsAuaarucFTi")
...
ꜰɪʀ ʙᴏᴛ ᴋᴇ ᴏᴡɴᴇʀ ᴀᴘᴋᴀ ʏᴇ ʀᴇQᴜᴇꜱᴛ ᴀᴄᴄᴇᴘᴛ ᴋᴀʀ ʟᴇɴɢᴇ @ROYAL_PREET_MEHRA. 

🍓 Sᴛᴇᴘ 4 - ɢʀᴏᴜᴘ ᴍᴇ "/database - ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ɪᴅ" ᴛʏᴘᴇ ᴋᴀʀ ᴋᴇ ꜱᴇɴᴅ ᴋᴀʀɴᴀ ʜᴏɢᴀ.

ꜰɪʀ ʙᴏᴛ ᴋᴇ ᴏᴡɴᴇʀ ᴀᴘᴋᴀ ʏᴇ ʀᴇQᴜᴇꜱᴛ ʙʜɪ ᴀᴄᴄᴇᴘᴛ ᴋᴀʀ ʟᴇɴɢᴇ@ROYAL_PREET_MEHRA  
